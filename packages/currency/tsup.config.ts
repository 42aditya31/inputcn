...
export default defineConfig([
  ...
  { ...shared, entry: ["src/currency.ts", "src/schema.ts"], clean: true },
  ...
  { ...shared, entry: ["src/index.ts", "src/use-currency-input.ts", "src/currency-input.tsx"], clean: false, treeshake: false, banner: { js: '"use client"' } },
])
